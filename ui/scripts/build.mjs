// Build the projects plugin UI.
//
//   src/projects.ts -> dist/scripts/projects.js  (esbuild bundle, ESM)
...
await esbuild.build({
    entryPoints: [path.join(srcDir, "projects.ts")],
    bundle: true,
    format: "esm",
    target: ["es2022"],
    platform: "browser",
...
// Copy public/ assets verbatim — projects.html and anything else the
...
console.log("built projects plugin UI -> dist/");
